...
* Internal enterprise web system, a freight booking web application that integrates with CargoWise via Universal XML. 
...
Feature description: please refer to attached mockup, these are screenshots of old system, please update or change them if needed.
